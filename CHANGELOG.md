...
Also added a unforceSubscription method, which cancels the effect of forceSubscription, for completeness.
...
- Fixed the nullability notes on the trigger field in the MpnSubscriptionInfo class, which can be null.
